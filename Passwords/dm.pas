...
type
  Tdm1 = class(TDataModule)
    ...
    fqPasswŒÔËÒ‡ÌËÂ: TWideMemoField;
    fqPassw Ó‰_Ô‡ÓÎˇ: TFDAutoIncField;
    procedure fc1BeforeConnect(Sender: TObject);
    procedure fqPasswŒÔËÒ‡ÌËÂGetText(Sender: TField; var Text: string;
      DisplayText: Boolean);
  private
...
procedure Tdm1.fqPasswŒÔËÒ‡ÌËÂGetText(Sender: TField; var Text: string;
  DisplayText: Boolean);
begin
